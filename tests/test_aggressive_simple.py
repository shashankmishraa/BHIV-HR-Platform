...
class AggressiveTester:
    ...
    def run_comprehensive_tests(self):
        ...
        test_cases = [
            ...
            # Job Management
            ("POST", f"{BASE_URL}/v1/jobs", {"title": "Test Job", "description": "Test", "requirements": ["Python"]}, 200, "Create Job"),
    ...
    def performance_test(self):
        ...
        for endpoint in performance_endpoints:
            ...
            if times:
                ...
                self.log(f"Performance {endpoint.split('/')[-1]}: {avg_time:.1f}ms average")
