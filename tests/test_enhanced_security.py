...
class SecurityTestSuite:
    ...
    def test_cookie_security(self):
        ...
        try:
            ...
            response = requests.post(
                f"{self.base_url}/v1/sessions/create", json=login_data
            )
    ...
    def test_api_key_management(self):
        ...
        try:
            ...
            response = requests.get(f"{self.base_url}/health", headers=test_headers)
    ...
    def test_security_headers(self):
        ...
        try:
            ...
            print(
                f"✅ Security Headers: {passed_headers}/{len(security_headers)} headers present"
            )
...
def run_security_tests():
    ...
    if passed == total:
        ...
        print(
            f"[WARNING] {total - passed} security tests failed. Review implementation."
        )
