...
class TestSemanticEngine(unittest.TestCase):
    ...
    def test_model_manager_initialization(self):
        ...
        print(f"Model Manager: {stats['skill_embeddings_count']} skills, {stats['job_templates_count']} templates")
    ...
    def test_semantic_job_matcher(self):
        ...
        print(f"Semantic Matcher: Score {result['overall_score']:.3f}, Skills: {result['matched_skills']}")
    
    def test_advanced_semantic_matcher(self):
        """Test advanced semantic matcher with bias mitigation"""
        result = self.advanced_matcher.advanced_match(self.sample_job, self.sample_candidate)
        ...
        print(f"Advanced Matcher: Score {result['score']}, Bias Adjusted: {result['bias_adjusted']}")
