"""
Database initialization module for Render deployment
Creates all necessary tables and populates sample data
"""
...
def get_database_url():
    ...
    return os.getenv("DATABASE_URL", "postgresql://bhiv_user:bhiv_pass@db:5432/bhiv_hr")
...
def populate_sample_data(engine):
    ...
    ('DevOps Engineer', 'Infrastructure', 'Remote', 'Senior', 'AWS, Docker, Kubernetes, CI/CD, 4+ years experience', 'Manage cloud infrastructure and deployment pipelines...', 'active'),
    ('Product Manager', 'Product', 'Austin', 'Mid-Level', 'Product strategy, Analytics, Agile, 3+ years experience', 'Drive product strategy and work with engineering teams...', 'active')
...
def initialize_render_database():
    """Complete database initialization for Render"""
    try:
        ...
        return {
            ...
            "tables_created": ["candidates", "jobs", "feedback", "interviews", "offers", "clients", "matching_cache"],
            "sample_data": "populated"
        }
