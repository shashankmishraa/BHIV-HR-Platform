...
class JobCreate(BaseModel):
    ...
    requirements: Union[List[str], str] = Field(
        ..., description="Skills and requirements as list or comma-separated string"
    )
    ...
    def normalize_experience_level(cls, v):
        ...
        if not normalized:
            raise ValueError(
                f"Invalid experience level: {v}. Must be one of: Entry, Mid, Senior, Lead, Executive"
            )
        return normalized
...
class JobUpdate(BaseModel):
    ...
    requirements: Optional[Union[List[str], str]] = Field(
        None, description="Skills and requirements as list or comma-separated string"
    )
