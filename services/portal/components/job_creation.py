...
def show_job_creation(
    API_BASE, headers, SECURITY_ENABLED, sanitizer=None, form_limiter=None
):
    ...
    with st.form("job_form"):
        ...
        with col1:
            ...
            location = st.text_input(
                "Location", placeholder="e.g., Remote, New York, London"
            )
        ...
        if submitted and title and description:
            ...
            if (
                SECURITY_ENABLED
                and form_limiter
                and not form_limiter.is_allowed(session_id)
            ):
