...
class ServiceConfig:
    ...
    def _get_agent_url(self) -> str:
        ...
        if self.environment == "production":
            return os.getenv("AGENT_SERVICE_URL", "https://bhiv-hr-agent-o6nx.onrender.com")
        else:
    ...
    def _get_client_portal_url(self) -> str:
        ...
        if self.environment == "production":
            return os.getenv("CLIENT_PORTAL_URL", "https://bhiv-hr-client-portal-zdbt.onrender.com")
        else:
