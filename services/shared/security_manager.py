...
class SecurityManager:
    ...
    def __init__(self):
        ...
        logger.info(
            f"Security Manager initialized for {self.config.environment.value} environment"
        )
    ...
    def _get_secure_api_key(self, environment: SecurityLevel) -> str:
        ...
        if not api_key:
            ...
            logger.warning(
                "Using fallback API key for development. Set API_KEY_SECRET for production."
            )
    ...
    def _get_jwt_secret(self, environment: SecurityLevel) -> str:
        ...
        if not jwt_secret:
            ...
            logger.warning(
                "Using fallback JWT secret for development. Set JWT_SECRET for production."
            )
    ...
    def generate_jwt_token(
        self, payload: Dict[str, Any], expires_hours: int = None
    ) -> str:
...
class APIKeyManager:
    ...
    def generate_api_key(
        self, client_id: str, permissions: List[str] = None
    ) -> Dict[str, Any]:
